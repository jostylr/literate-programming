...
Doc = function (md, options) {
  ...
  this.directives = {
    ...
    "load": function (options, name, link) {
      var doc = this,
        fname,
        ind;
      ...
      if (fname.slice(0, 4) === "http") {
        callback({
          message: "http requests not done yet"
        }, typeof http);
      } else {
...
Doc.prototype.addConstants = function (a, b) {
  var doc = this;
  var name, obj;
...
Doc.prototype.addMacros = function (newobj, value) {
  var doc = this;
...
Doc.prototype.addCommands = function (newobj, value) {
  var doc = this;
...
Doc.prototype.addTypes = function (newobj, value) {
  var doc = this;
...
Doc.prototype.addDirectives = function (newobj, value) {
  var doc = this;
