...
Starting from the parent directory, type `literate-programming logs.md` to compile.
...
[main](#Structure ":| md | compile")
    ...
    \1_"Table of Factorials"

    \1_"Factorial for all"

    \1_"Behind the scenes"
...
[](# ":| md | compile ")
    ...
    \1_"Code block for factorial:editable code"

    \1_"Code block for factorial:html"
...
[editable code](# ":| jshint | html-wrap textarea, runnable, cols='120', rows = '10' ")
...
Here we define the loop, get the result and format it appropriately. n is already defined as its definition differs. 
    ...
    nf = lf10 < 6 ? Math.round(Math.pow(10, lf10) ) : 
        Math.pow(10, lf10-Math.floor(lf10)).toPrecision(6) + "E" + Math.floor(lf10);
...
[](# ":| md | compile")
    ...
    \1_":Factorial Table| eval | html-table rowswheader"
